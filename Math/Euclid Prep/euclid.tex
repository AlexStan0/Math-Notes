...
\begin{document}
    ...
    The formula for the integration of finding the volume between two functions is 

    \[
        V = \pi\int_a^b (R^2) dx    
    \]

    where $R$ is the top function minus the bottom function. 

    \textbf{Example: }

    Region $R$ is bounded by the lines $y = 4, x = 6$, y-axis, and the x-axis. Region R is
