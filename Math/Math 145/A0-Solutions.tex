...
%% header
\pagestyle{fancy}
\fancyhead[L]{\bf\large MATH145: Advanced Algebra 1 \\ Written Assignment 0 Solutions}
...
\begin{document}
	\begin{enumerate}[{\bf Q1.}] 
        ...
        \item Define that $f(x) = x^3 + 2x$ and that $\alpha = 2$ then $f(\alpha) > 4 \implies x\le\alpha$ for all $x\in S$.
        Therefore, the set $S$ is bounded above
