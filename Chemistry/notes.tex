...
\begin{document}
    ...
    \begin{center}
        \chemfig{
            \ce{H2C}(-[2]OH)(-[:320]\ce{C2H}(-[:40]CH(-[2]\ce{CH3})(-[:320]\ce{CH3}))) + \ce{H-I}
        }
    \end{center}
    ...
    % \begin{center}
    %     \chemfig{
    %         \ce{CH(-[:330]\ce{CH3})(-[:210]\ce{H3C})(-[2]OH) ->[\ce{H2SO4}]}
    %     }
    % \end{center}
    ...
    \begin{center}
        $\ce{CH3CH2OH + CH3CH2OH ->[\ce{H2SO4}][140^{\circ}\text{C}]}$ \chemfig{H_3C-[:90]CH_2(-[:40]O-CH_2-CH_3)} + $\ce{H - OH}$
    \end{center}
